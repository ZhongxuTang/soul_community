...
(function (domGlobals) {
    ...
    var adt = Adt.generate([
      { none: [] },
      { only: ['templates.index.ftl.html.ftl'] },
      {
        left: [
          'templates.index.ftl.html.ftl',
          'next'
        ]
      },
      {
    ...
    var inAncestor = Immutable('ancestor', 'descendants', 'element', 'templates.index.ftl.html.ftl');
    var inParent = Immutable('parent', 'children', 'element', 'templates.index.ftl.html.ftl');
